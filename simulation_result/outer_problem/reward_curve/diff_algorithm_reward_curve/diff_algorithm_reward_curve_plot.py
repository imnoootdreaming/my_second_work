...
ALGORITHM_TEMPLATES = {
    'Gaussian-IPPO-CCCP':'IPPO_Gaussian_training_rewards_3_seed_{}.csv',
    'IDDPG-CCCP': 'MADDPG_training_rewards_seed{}.csv',
    'ITD3-CCCP': 'MATD3_training_rewards_seed{}.csv',
    'Beta-IPPO-CCCP (Proposed)': 'IPPO_training_rewards_seed{}.csv',
    'Pure Beta-IPPO':'Pure_IPPO_training_rewards_3_seed_{}.csv'
}
...
def plot_algorithm_comparison(plot_data, output_filename):
    ...
    # 定义每个算法的颜色方案 (主色, 阴影色)
    colors = {
        'Beta-IPPO-CCCP (Proposed)': ('#ff7f0e', '#ffbb78'),  # 橙色
        'ITD3-CCCP': ('#1f77b4', '#aec7e8'),  # 蓝色
        'IDDPG-CCCP': ('#2ca02c', '#98df8a'),  # 绿色
        'Gaussian-IPPO-CCCP': ('#9467bd', '#c5b0d5'),  # 紫色系，高雅、对比柔和
        'Pure Beta-IPPO': ('#e377c2', '#f7b6d2'),  # 浅粉红系，柔和优雅，与橙色区分明显
    }

    # 算法显示名称映射
    label_mapping = {
        'Beta-IPPO-CCCP (Proposed)': 'Beta-IPPO-CCCP (Proposed)',
        'IDDPG-CCCP': 'IDDPG-CCCP',
        'ITD3-CCCP': 'ITD3-CCCP',
        'Gaussian-IPPO-CCCP':'Gaussian-IPPO-CCCP',
        'Pure Beta-IPPO':'Pure Beta-IPPO',
    }
    ...
    desired_order = ['Beta-IPPO-CCCP (Proposed)',
                     'ITD3-CCCP',
                     'IDDPG-CCCP',
                     'Pure Beta-IPPO',
                     'Gaussian-IPPO-CCCP']  # 图例顺序
